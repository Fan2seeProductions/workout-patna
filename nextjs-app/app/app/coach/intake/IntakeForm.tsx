...
const STYLES = ['strength','hypertrophy','endurance','mixed','peloton','work from home','desk worker'] as const
    ...
    <main className="min-h-dvh px-6 pt-6 pb-32 max-w-md mx-auto">
      ...
      <div className="mt-6 space-y-6">
        ...
        <Field label="Push notifications">
          <div className="flex items-center justify-between rounded-xl border border-[var(--color-border)] bg-white/[0.04] p-3">
            <span className="text-[13px] text-white/85">Workout reminders</span>

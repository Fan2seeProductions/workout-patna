...
// Google sign-in is hidden unless the Google OAuth provider has been enabled
// on the Supabase project (otherwise it 400s: "provider is not enabled").
    ...
    <div className="min-h-screen bg-[#0d0d0d] flex flex-col md:flex-row">
      ...
      <div className="flex-1 flex flex-col p-6 md:p-12 bg-[#0d0d0d]">
        ...
        <div className="w-full max-w-md space-y-8">
          ...
          {/* Divider + Google — only shown once the Google OAuth provider is
              actually enabled on the Supabase project. Set
              NEXT_PUBLIC_GOOGLE_AUTH_ENABLED=true after configuring it, or the
              button 400s with "provider is not enabled". */}
          {GOOGLE_ENABLED && (
            <div>

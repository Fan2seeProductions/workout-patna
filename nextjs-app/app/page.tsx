  ...
  return (
    <main>
      ...
      <section aria-labelledby="how-heading">
        ...
        <ol>
          <li>
            ...
            center, community center, or favorite park near Cypress, Houston, or
            surrounding areas.
          </li>
          <li>
          ...
          <li>
            <strong>Match with gym partners.</strong> Browse and connect with members
            at the same location who share your schedule and goals.
          </li>
          <li>
            <strong>Work out together.</strong> Show up consistently, hold each other
            accountable, and build a fitness habit that sticks.
          </li>
        </ol>
      </section>
      ...
      <section aria-labelledby="accountability-heading">
        <h2 id="accountability-heading">
          Built for Fitness Accountability and Consistency
        </h2>
        <p>
